...
import { ImageUpload, type ImageFile } from "@/components/admin/ImageUpload";
  ...
  const onSubmit: SubmitHandler<FieldValues> = async (formData) => {
    ...
    try {
      ...
      const imagePromises = images.map(
        (img) =>
          new Promise<{ name: string; data: string; isMain: boolean }>((resolve) => {
      ...
      // TODO: Implement server action for database insertion
