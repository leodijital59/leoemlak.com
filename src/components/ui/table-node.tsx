...
import { Popover as PV } from 'radix-ui';
...
import type { DropdownMenu as DP} from 'radix-ui';
...
function TableFloatingToolbar({
    ...
    return (
        <Popover
            ...
            modal={false}
        >
            <PV.PopoverAnchor asChild>{children}</PV.PopoverAnchor>
            <PopoverContent
                asChild
...
function TableBordersDropdownMenuContent(
    props: React.ComponentProps<typeof DP.Content>
) {
